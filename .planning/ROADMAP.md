...
- [x] 02-04-PLAN.md — S4 Dataset Overview block (full-width stats + AI-label breakdown + safe-harbour disclaimer)
- [x] 02-05-PLAN.md — S5 + S6 InstitutionsChart with D3 animated re-sort
**UI hint**: yes
...
- [x] 03-03-PLAN.md — S8 word cloud + S9 record-table overlay vertical slice (filter bar, institution search, flex-wrap cloud with per-dataset font scaling, S9 overlay with lazy fetch + wordCache, mobile <480px chip strip)
**UI hint**: yes
